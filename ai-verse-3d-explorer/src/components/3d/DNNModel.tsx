...
export function DNNModel({
  ...
  const layersConfig = [
    { count: 5, color: '#38bdf8', name: 'Input Layer', x: -6 },
    { count: 6, color: '#818cf8', name: 'Hidden Layer 1', x: -2 },
    { count: 5, color: '#c084fc', name: 'Hidden Layer 2', x: 2 },
    { count: 3, color: '#f43f5e', name: 'Output Layer', x: 6 }
  ];
